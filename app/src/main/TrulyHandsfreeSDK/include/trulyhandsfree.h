...
#define THF_VERSION      "4.3.0"
#define THF_VERSION_MAJOR 4
#define THF_VERSION_MINOR 3
#define THF_VERSION_PATCH 0
#define THF_VERSION_PRE  ""
#define THF_VERSION_ID    84
...
typedef enum {
  ...
  SPEAKER_ADAPT_TYPE, SPEAKER_DSP_SV_THRESH
} thfSpeakerConfig_t;
...
typedef enum {
  ...
  UDT_CHECK_POOR_RECORDINGS, UDT_CHECK_VOWEL_DUR, UDT_CHECK_REPETITION,
